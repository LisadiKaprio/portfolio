...
### Art assets and lessons learned

This was one of the first projects where I drew simple 2D animations, and made sure characters can have different outfits or skins that also adjust to the animations.

::lightbox-images{:items='["chat-village-outfits.jpg"]'}
::

::lightbox-images{:items='["chat-village-1.jpg"]'}
::

These are early concepts for the avatars, their animations and the interactions.

::lightbox-images{:items='["chat-village-concept-1.jpg"]'}
::